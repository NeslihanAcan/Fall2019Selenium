...
public class RegistrationForm {
    ...
    public void test1(){
        ...
        driver.findElement(firstNameBy).sendKeys("Neslihan");
        driver.findElement(lastNameBy).sendKeys("Acan");
        driver.findElement(usernameBy).sendKeys("neslican");
        driver.findElement(emailBy).sendKeys("neslihan@hotmail.com");
        driver.findElement(passwordBy).sendKeys("abc12345");
        driver.findElement(phoneBy).sendKeys("111-234-4589");
